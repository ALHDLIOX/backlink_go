...
Last checked: [YYYY-MM-DD HH:MM local time]
...
- [YYYY-MM-DD HH:MM local time] | event_id=[opaque ID] | action=[canonical action] | result=[result] | evidence=[opaque reference]
