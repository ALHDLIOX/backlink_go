...
Use `wrap-platform-notes` to set Cost Detail, Verification Pattern, and Notes to WRAP across the Platforms columns. This command changes only wrap strategy and verifies that the existing column widths are unchanged.
