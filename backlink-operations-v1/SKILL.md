...
4. If schema 4, 5, or 6 is reported, run `migrate-schema-v7`. Stop if OAuth, workbook identity, schema, or headers remain invalid.
...
- `../submit-product-directories-v1-batch/references/status-model.md`: unified schema 7 fields and invariants.
