...
- Primary product evidence: [public room-planner page](https://raumplaner.io/en/room-planner-online); legacy repository commit `6d78fd26` paths `src/shared/blocks/room-planner/room-planner-context.tsx`, `room-planner-content.tsx`, `sidebar-image-section.tsx`, `sidebar-furniture-section.tsx`, `src/shared/blocks/projects/project-detail.tsx`, and `src/app/api/projects/route.ts`.
